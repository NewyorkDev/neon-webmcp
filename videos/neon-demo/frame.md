...
description: >
  ...
  JetBrains Mono taxonomy, DM Sans body, the four-accent palette. Composition,
...
typography:
  ...
  body-lg:    { fontFamily: "DM Sans", px: 28, cqw: 1.46, weight: 400, lineHeight: 1.4 }
  body-md:    { fontFamily: "DM Sans", px: 24, cqw: 1.25, weight: 400, lineHeight: 1.3 }
...
This is the **creative-mode** preset remixed onto the captured brand. The YAML frontmatter above (colors · typography · components) is **normative and already correct — use it verbatim.** The prose below is the ORIGINAL preset's intent; read it THROUGH the frontmatter:

- **Fonts** — already set to **DM Sans** (display) / **Syne** (body); ignore any preset font name lingering in prose.
...
counter, and axis as a "technical artifact" register. **DM Sans** carries the few body lines.
